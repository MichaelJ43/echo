...
- **Security:** **`SECURITY.md`** — vulnerability reporting and notes on dependency advisories constrained by upstream (e.g. Tauri’s Linux `glib` stack; build-time `rand` 0.7 via `kuchikiki`).
